...
//    }
     ...
     * Intuition
     *
     * If we had some way of counting instances of the majority element as +1+1 and instances of any other element as -1−1, summing them would
     * make it obvious that the majority element is indeed the majority element.
     *
     * Algorithm
     *
     ...
     * so the 5 at index 6 will be the next candidate. In this case, 7 is the true majority element, so by disregarding this prefix,
