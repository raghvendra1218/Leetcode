...
/**
 * Intuition : While traversing the flower bed we will plant the trees checking the conditon as posed by the question.
 * We will have to deal with the start and end separately.
 */
